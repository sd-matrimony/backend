import { z } from "zod";
import { educationEnum, maritalStatusEnum, nakshatraEnum, rasiEnum, ageRangeEnum, salaryRangeEnum, userSchema, imgFileSchema, } from "./general.js";
...
export const matchedUsersSchema = z.object({
    ...
    nakshatra: enumQuery(nakshatraEnum).optional(),
    rasi: enumQuery(rasiEnum).optional(),
    lagna: enumQuery(rasiEnum).optional(),
...
export const imgUploadSchema = z.object({
    ...
    images: z.preprocess((val) => Array.isArray(val) ? val : [val], z.array(imgFileSchema).min(1, "At least one image is required")),
});
