...
export const professionalDetailsSchema = z.object({
    ...
    .refine((data) => !(data.profession === "Unemployed" && data.sector === "Unemployed") ||
    data.salary === 0, {
    path: ["salary"],
    error: "Salary must be 0 when unemployed",
})
    .refine((data) => data.sector === "Unemployed" || data.profession !== "Unemployed", {
    path: ["profession"],
...
export const partnerPreferencesSchema = z.object({
    ...
    .refine((data) => (typeof data.minAge === "number" && typeof data.maxAge === "number")
...
export const userSchema = z.object({
    ...
    .refine((data) => isValidDob(data.dob), {
